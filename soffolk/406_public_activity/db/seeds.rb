ryan = User.where(name: "Ryan").first_or_create!(password: "secret")
joe = User.where(name: "Joe").first_or_create!(password: "secret")
anne = User.where(name: "Anne").first_or_create!(password: "secret")
